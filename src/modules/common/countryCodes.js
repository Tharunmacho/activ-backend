...
/** The handful the website offers above the alphabetical list. */
const PRIORITY_ISO2 = ['IN', 'AE', 'SA', 'SG', 'MY', 'GB', 'US', 'AU', 'CA'];
...
const countryByIso2 = (iso2) => BY_ISO2.get(String(iso2 === null || iso2 === undefined ? '' : iso2).toUpperCase());

/**
 * Longest-prefix match on a '+'-prefixed number. See the TypeScript twin for
 * why longest, and how a shared code ('1', '44') is resolved.
 */
const countryFromDial = (value) => {
